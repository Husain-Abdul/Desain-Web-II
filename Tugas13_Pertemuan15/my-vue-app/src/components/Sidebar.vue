    ...
    <aside
        ...
        <div
            ...
            <img class="rounded-full"
                ...
                alt="">
            <h2 class="md:text-white text-lg font-semibold mt-2">Husain Abdul Ghani</h2>
            <p class="md:text-white text-sm">husainabdulghani@gmail.com</p>
        </div>
        <nav class="md:text-white space-y-4 flex flex-col justify-center mt-40 md:mt-24 w-full">
            ...
            <router-link to="/my-task" exact-active-class="bg-[#ff6767]/30 md:bg-white text-[#ff6767] rounded-md"
                ...
                <p class="font-semibold">All Task</p>
            </router-link>
